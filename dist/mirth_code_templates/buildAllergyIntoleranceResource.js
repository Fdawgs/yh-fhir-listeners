...
function buildAllergyIntoleranceResource(data) {
  ...
  resource.assertedDate = newStringOrUndefined(getResultSetString(data, 'assertedDate')); // Very unlikely that an allergy record will have multiple components like this
  ...
  resource.patient = {
    reference: "".concat($cfg('apiUrl'), "/r3/Patient/").concat(getResultSetString(data, 'patientReference'))
  };
